...
export function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>Neural Platform Bridge</CardTitle>
      <CardDescription>
        MindBridge intelligently connects ChatGPT, Claude, Gemini, and Copilot into a single unified context.
      </CardDescription>
    </Card>
  );
}
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-50 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
